...
Research rationale (private KB; not required to run): https://github.com/lufs-audio/kb/tree/main/docs/product/clank-agent-sport . House conventions: bplate docs/units/08-documentation-and-workflow-standard.md and 10-exit-code-and-json-envelope-standard.md. Global speccing/land-plane skills live in danialrami/dotfiles; do not vendor them. This is a standalone game, not a Workchain component or lsbx consumer.
